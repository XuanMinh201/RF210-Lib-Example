/*
    This example shows LoRaWan protocol joining the network in OTAA mode, class A, region AS923.
...
String DEVEUI = "70B3D57ED0063E5E";
String APPEUI = "0000000000000001";
String APPKEY = "B830FBF40C2DC42B8672757D0F4120D8";
...
void setup()
{
  ...
  Serial.println("==============================");
  Serial.println("RF210 - LoRaWAN OTAA");
  Serial.println("==============================");
  mySerial1.println("ATR"); // Set OTAA
  delay(3000);
...
void loop()
{
  ...
  int temp = (int16_t) 100 * measure_temp();
...
bool join_otaa() {
  flush_serial_AT();
  mySerial1.println("AT+JOIN=1:0:10:0");
  String join;
  delay(100);
  if (mySerial1.available()) {
